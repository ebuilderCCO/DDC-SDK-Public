...
enum DeviceIdType : NSInteger;

SWIFT_CLASS("_TtC4iddc10DdcManager")
...
- (nonnull instancetype)initWithKey:(NSString * _Nonnull)key systemId:(NSString * _Nonnull)systemId deviceId:(NSString * _Nonnull)deviceId deviceIdType:(enum DeviceIdType)deviceIdType OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end


@interface DdcManager (SWIFT_EXTENSION(iddc))
